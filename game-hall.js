...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function renderMarkdown(markdownText) {
        ...
        // 在 marked.js 处理之前，手动把 ||text|| 替换成带特定class的HTML标签
...
`;
    ...
    /**
     * 【卧底】等待用户行动的通用函数（已修复placeholder错误）
     */
